...
//            VBox articleContainer = new VBox(10);
//            articleContainer.getChildren().addAll(imageView, textVBox);
//            articleContainer.setStyle("-fx-background-color: " + frameColor + "; -fx-padding: 10px; -fx-border-color: " + borderColor + "; -fx-border-width: 3px; -fx-margin: 20px;");
//
//            // Ajouter le conteneur d'article à la grille
//            articleGridPane.add(articleContainer, column, row);
//            column++;
...
//
//}
//package controllers.blog;//package controllers.blog;//package controllers.blog;
//
//import javafx.fxml.FXML;
//import javafx.fxml.FXMLLoader;
//import javafx.scene.Node;
...
//
//
////import controllers.blog.Reactions;
