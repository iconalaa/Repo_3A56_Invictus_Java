...
public class DonateurController implements Initializable {
  ...
  private void deleteDonor(ActionEvent event) {
    Donateur selectedDonateur = tableDonors
      .getSelectionModel()
      .getSelectedItem();
    if (selectedDonateur != null) {
      try {
        ...
        showAlert(
          ...
          "Success",
          "Donateur deleted successfully"
        );
      } catch (SQLException e) {
        showAlert(
          Alert.AlertType.ERROR,
          "Error",
          "Failed to delete donateur: " + e.getMessage()
        );
      }
    } else {
      showAlert(
        ...
        "Warning",
        "Please select a donateur to delete"
      );
    }
  }
  ...
  private void modifyDonor(ActionEvent event) throws IOException {
    ...
    if (selectedDonateur != null) {
      FXMLLoader loader = new FXMLLoader(
        getClass().getResource("/fxml/dons/updateDonateur.fxml")
      );
      ...
      showAlert(
        Alert.AlertType.WARNING,
        "Warning",
        "Please select a donateur to modify"
      );
    }
  }
 ...
 */
  ...
  private void initializeTable() {
    ...
    prenomColumn.setCellValueFactory(
      new PropertyValueFactory<>("prenom_donateur")
    );
    ...
    if (query.isEmpty()) {
      ...
      ObservableList<Donateur> filteredList = FXCollections.observableArrayList(
        donateursList
          .stream()
          .filter(d ->
            d.getNom_donateur().toLowerCase().contains(query) ||
  ...
  private void navigateToDonations(ActionEvent event) {
    try {
      FXMLLoader loader = new FXMLLoader(
        getClass().getResource("/fxml/dons/Donateurs.fxml")
      );
      Parent root = loader.load();
  ...
  private void navigateToGratifications(ActionEvent event) {
    try {
      FXMLLoader loader = new FXMLLoader(
        getClass().getResource("/fxml/dons/Gratifications.fxml")
      );
      Parent root = loader.load();
      Stage stage = (Stage) menu.getScene().getWindow();
      stage.setScene(new Scene(root));
  ...
  void profileAction(MouseEvent event) throws IOException {
    FXMLLoader loader = new FXMLLoader(
      getClass().getResource("/fxml/user/profile.fxml")
    );
    Parent root = loader.load();
    ...
    stage
      .getIcons()
      .add(new Image(getClass().getResourceAsStream("/img/logo/favicon.png")));
  ...
  public void showScene(MouseEvent event, String path, String title) {
    ...
    try {
      ...
      stage
        .getIcons()
        .add(
          new Image(getClass().getResourceAsStream("/img/logo/favicon.png"))
        );
